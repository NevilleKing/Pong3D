...
const GLfloat worldBoundsVertexData[] = {
	//	    X        Y        Z        R     G     B      A
	// Front face
	-0.250f, -0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  0.3f, // 4
	-0.250f,  0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  0.3f, // 1
	 0.250f, -0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  0.3f, // 3
	-0.250f,  0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  0.3f, // 1
	 0.250f, -0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  0.3f, // 3
	 0.250f,  0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  0.3f, // 2

														  // Back face
	-0.250f, -0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  0.3f, // 8
	-0.250f,  0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  0.3f, // 5
	 0.250f, -0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  0.3f, // 7
	-0.250f,  0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  0.3f, // 5
	 0.250f, -0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  0.3f, // 7
	 0.250f,  0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  0.3f, // 6

														  // Left Face
	-0.250f, -0.125f, -0.125f,    0.0f, 0.0f, 1.0f,  0.3f, // 4
	-0.250f,  0.125f, -0.125f,    0.0f, 0.0f, 1.0f,  0.3f, // 1
	-0.250f, -0.125f,  0.125f,    0.0f, 0.0f, 1.0f,  0.3f, // 8
	-0.250f,  0.125f, -0.125f,    0.0f, 0.0f, 1.0f,  0.3f, // 1
	-0.250f,  0.125f,  0.125f,    0.0f, 0.0f, 1.0f,  0.3f, // 5
	-0.250f, -0.125f,  0.125f,    0.0f, 0.0f, 1.0f,  0.3f, // 8

														   // Right Face
	 0.250f,  0.125f, -0.125f,    0.0f, 0.5f, 0.0f,  0.3f, // 2
	 0.250f, -0.125f, -0.125f,    0.0f, 0.5f, 0.0f,  0.3f, // 3
	 0.250f, -0.125f,  0.125f,    0.0f, 0.5f, 0.0f,  0.3f, // 7
	 0.250f, -0.125f,  0.125f,    0.0f, 0.5f, 0.0f,  0.3f, // 7
	 0.250f,  0.125f,  0.125f,    0.0f, 0.5f, 0.0f,  0.3f, // 6
	 0.250f,  0.125f, -0.125f,    0.0f, 0.5f, 0.0f,  0.3f, // 2

														  // Bottom Face
	-0.250f, -0.125f, -0.125f,    0.0f, 0.5f, 0.5f,  0.3f, // 4
	-0.250f, -0.125f,  0.125f,    0.0f, 0.5f, 0.5f,  0.3f, // 8
	 0.250f, -0.125f, -0.125f,    0.0f, 0.5f, 0.5f,  0.3f, // 3
	 0.250f, -0.125f, -0.125f,    0.0f, 0.5f, 0.5f,  0.3f, // 3
	 0.250f, -0.125f,  0.125f,    0.0f, 0.5f, 0.5f,  0.3f, // 7
	-0.250f, -0.125f,  0.125f,    0.0f, 0.5f, 0.5f,  0.3f, // 8

														   // Top Face
	-0.250f,  0.125f,  0.125f,    0.5f, 0.5f, 0.0f,  0.3f, // 5
	-0.250f,  0.125f, -0.125f,    0.5f, 0.5f, 0.0f,  0.3f, // 1
	 0.250f,  0.125f, -0.125f,    0.5f, 0.5f, 0.0f,  0.3f, // 2
	 0.250f,  0.125f, -0.125f,    0.5f, 0.5f, 0.0f,  0.3f, // 2
	 0.250f,  0.125f,  0.125f,    0.5f, 0.5f, 0.0f,  0.3f, // 6
	-0.250f,  0.125f,  0.125f,    0.5f, 0.5f, 0.0f,  0.3f, // 5
};
