...
//	    X        Y        Z        R     G     B      A
// Front face
	-0.125f, -0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  1.0f, // 4
	-0.125f,  0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  1.0f, // 1
	 0.125f, -0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  1.0f, // 3
	-0.125f,  0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  1.0f, // 1
	 0.125f, -0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  1.0f, // 3
	 0.125f,  0.125f, -0.125f,    1.0f, 0.0f, 0.0f,  1.0f, // 2

// Back face
	-0.125f, -0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  1.0f, // 8
	-0.125f,  0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  1.0f, // 5
	 0.125f, -0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  1.0f, // 7
	-0.125f,  0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  1.0f, // 5
	 0.125f, -0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  1.0f, // 7
	 0.125f,  0.125f,  0.125f,    0.0f, 1.0f, 0.0f,  1.0f, // 6

// Left Face
	-0.125f, -0.125f, -0.125f,    0.0f, 0.0f, 1.0f,  1.0f, // 4
	-0.125f,  0.125f, -0.125f,    0.0f, 0.0f, 1.0f,  1.0f, // 1
	-0.125f, -0.125f,  0.125f,    0.0f, 0.0f, 1.0f,  1.0f, // 8
	-0.125f,  0.125f, -0.125f,    0.0f, 0.0f, 1.0f,  1.0f, // 1
	-0.125f,  0.125f,  0.125f,    0.0f, 0.0f, 1.0f,  1.0f, // 5
	-0.125f, -0.125f,  0.125f,    0.0f, 0.0f, 1.0f,  1.0f, // 8

// Right Face
	 0.125f,  0.125f, -0.125f,    0.0f, 0.5f, 0.0f,  1.0f, // 2
	 0.125f, -0.125f, -0.125f,    0.0f, 0.5f, 0.0f,  1.0f, // 3
	 0.125f, -0.125f,  0.125f,    0.0f, 0.5f, 0.0f,  1.0f, // 7
	 0.125f, -0.125f,  0.125f,    0.0f, 0.5f, 0.0f,  1.0f, // 7
	 0.125f,  0.125f,  0.125f,    0.0f, 0.5f, 0.0f,  1.0f, // 6
	 0.125f,  0.125f, -0.125f,    0.0f, 0.5f, 0.0f,  1.0f, // 2

// Bottom Face
	-0.125f, -0.125f, -0.125f,    0.0f, 0.5f, 0.5f,  1.0f, // 4
	-0.125f, -0.125f,  0.125f,    0.0f, 0.5f, 0.5f,  1.0f, // 8
	 0.125f, -0.125f, -0.125f,    0.0f, 0.5f, 0.5f,  1.0f, // 3
	 0.125f, -0.125f, -0.125f,    0.0f, 0.5f, 0.5f,  1.0f, // 3
	 0.125f, -0.125f,  0.125f,    0.0f, 0.5f, 0.5f,  1.0f, // 7
	-0.125f, -0.125f,  0.125f,    0.0f, 0.5f, 0.5f,  1.0f, // 8

// Top Face
	-0.125f,  0.125f,  0.125f,    0.5f, 0.5f, 0.0f,  1.0f, // 5
	-0.125f,  0.125f, -0.125f,    0.5f, 0.5f, 0.0f,  1.0f, // 1
	 0.125f,  0.125f, -0.125f,    0.5f, 0.5f, 0.0f,  1.0f, // 2
	 0.125f,  0.125f, -0.125f,    0.5f, 0.5f, 0.0f,  1.0f, // 2
	 0.125f,  0.125f,  0.125f,    0.5f, 0.5f, 0.0f,  1.0f, // 6
	-0.125f,  0.125f,  0.125f,    0.5f, 0.5f, 0.0f,  1.0f, // 5
};
// end::vertexData[]
